...
namespace creation
{
	...
	template < typename T_, bool HasStorage_ =  has_storage<T_>::value >
	...
	struct check_policy_v1_1<T_, true>
	{
		...
		static const bool matches =
			has_create<storage>::value &&
			has_get_ptr<storage>::value;
	...
	{
		using adapted_policy = typename wigwag::detail::policy_version_detector<check_policy_v1_1<T_>>::adapted_policy;
	};
