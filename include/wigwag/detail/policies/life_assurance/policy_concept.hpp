...
#include <wigwag/detail/disable_warnings.hpp>
	...
	template < typename T_, bool HasLockPrimitive_ =  has_life_assurance<T_>::value >
	...
	struct check_life_assurance<T_, true>
	{
		...
		static const bool value =
			has_node_should_be_released<life_assurance>::value &&
			has_release_node<life_assurance>::value;
	};


	template < typename T_, bool HasLockPrimitive_ =  has_life_checker<T_>::value >
	...
	template < typename T_, bool HasLockPrimitive_ =  has_execution_guard<T_>::value >
